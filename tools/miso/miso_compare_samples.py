...
input_gene1 = sys.argv[1]
input_gene2 = sys.argv[2]

htmlfile = sys.argv[3]

input_gene1_FOLDER = input_gene1.split('.')[0]+'_files'
input_gene2_FOLDER = input_gene2.split('.')[0]+'_files'
...
parameter = " --compare-samples "+input_gene1_FOLDER+" "+input_gene2_FOLDER+" "+OUTPUT_FOLDER
#print parameter
...
def htmloutput(htmlout,outputfolder):
	rstyle="""<style type="text/css">
        ...
        res.append(galhtmlattr % ('Compare Samples',timenow()))
