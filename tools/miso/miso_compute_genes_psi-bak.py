...
parameter = " --compute-genes-psi "+input_GFF_FOLDER+" "+input_BAM+" --output-dir "+OUTPUT_FOLDER+" --read-len "+read_len
...
os.chdir(galaxyhome + "/tools/miso/")

command="python2.7 ./misopy/run_events_analysis.py "+parameter
