...
VALID_BUILDS = ['PlasmoDB-32_PbergheiANKA_Genome', 'mm8', 'mm9', 'mm10', 'hg18', 'hg19', 'hg38', 'dm2', 'dm3', 'sacCer1', 'pombe', 'rn4', 'tair8' ] #HACK! FIXME: allow using all specified builds, would currently require hacking SICER's "GenomeData.py" on the fly.
...
def __main__():
    ...
    if options.control_file is not None:
        cmd = "/mnt/galaxyTools/tools/pymodules/python2.7/lib/python/sicer/SICER.sh"
    else:
        cmd = "/mnt/galaxyTools/tools/pymodules/python2.7/lib/python/sicer/SICER-rb.sh"
