...
if sys.argv[5]=="false": #Input_data2_source=none
    CPAS_FILE = ""    
else:
...
print "python","validator_cli.py","--input-file1",DAT_FILE,"--peak-cutoff",PEAK_CUTOFF,"--ms1-cutoff", MS1_CUTOFF,"--ms2-cutoff", MS2_CUTOFF,"--max-peak-diff", MAX_PEAK_DIFF,"--output-folder", OUTPUT_FOLDER
