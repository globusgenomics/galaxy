...
results_url = "https://6c263.0ec8.dn.glob.us"
results_path = "/data/results"
bdbags_url = "https://eba97.75bc.dn.glob.us"
bdbags_path = "/data/bags"
...
url_path = "%s/%s" % (results_url, to_loc)
...
s3_url = "%s/%s.zip" % (bdbags_url, bdbag_name)
