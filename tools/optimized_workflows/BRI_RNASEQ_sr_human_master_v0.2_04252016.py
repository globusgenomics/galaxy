...
def __main__():
    ...
    final_outputs = [ options.output_tophat_bam, options.output_picard_markDuplicates_html, options.output_picard_markDuplicates_bam, options.output_picard_markDuplicates_directory, options.output_picard_alignmentSummary, options.output_picard_alignmentSummary_directory, options.output_picard_collectRnaSeqSummary, options.output_picard_collectRnaSeqSummary_directory, options.output_tophatStats, options.output_htseq_no_dups_counts, options.output_fastqc_html, options.output_fastqc_text, options.output_log ]
